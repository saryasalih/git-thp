...
Le terminal de macOS et Linux est de type [Shell Unix](https://fr.wikipedia.org/wiki/Shell_Unix), tandis que celui de Windows est de type DOS. Ce qui fait que l'invite de commandes de Windows aura une utilisation différente de celui de type Unix Shell.
...
La solution de facilité pour les grands débutants du terminal est [Cygwin](https://www.cygwin.com). Pour t'aider, j'ai même réalisé une vidéo tutorielle pour son installation [Vidéo tutorielle](https://www.youtube.com/watch?v=YogNpgcKY9A&feature=youtu.be).
